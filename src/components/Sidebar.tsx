          ...
          items: [
            {
              id: divSlug,
              label: divLabel,
              icon: divisionIcons[divSlug] || <Sparkles size={16} />,
            },
          ],
        },
      ];
      ...
      return [
        {
          ...
          items: [
            ...
            {
              id: "lomba",
              label: "Daftar Perlombaan",
              icon: <Trophy size={16} />,
            },
            {
              id: "shop",
              label: "Toko KIMAS Store",
              icon: <ShoppingBag size={16} />,
            },
          ],
        },
        ...
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          {!isCollapsed && (
            <span className="font-display font-bold text-sm text-white tracking-widest whitespace-nowrap">
              POINTER{" "}
              <span className="text-brand-orange text-[10px]">SYSTEM</span>
            </span>
          )}
        </div>
        <button
          ...
          <div key={idx} className="space-y-1">
            ...
            {group.items.map((item) => {
              ...
              return (
                ...
                >
                  <span
                    className={`${isActive ? "text-brand-orange" : "text-zinc-500"}`}
                  >
                    {item.icon}
                  </span>
                  {!isCollapsed && (
      ...
      <div className="p-3 border-t border-dark-border bg-dark-bg/20">
        {!isCollapsed ? (
          <div className="flex items-center gap-3 p-2 bg-zinc-950 border border-zinc-800 rounded-xl">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-orange to-brand-orange-hover flex items-center justify-center font-display font-black text-xs text-white">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-zinc-500 truncate mt-0.5 capitalize">
                {currentUser.role}
              </div>
            </div>
            <button
